...
import com.devanshsaxena.onestoreadmin.adapter.CategoryAdapter
import com.devanshsaxena.onestoreadmin.databinding.FragmentCategoryBinding
...
class CategoryFragment : Fragment() {
    ...
    private var launchGalleryActivity = registerForActivityResult(
        ...
        if(it.resultCode == Activity.RESULT_OK){
            ...
            binding.Upload1.setImageURI(imageUrl)
        }
    }
    ...
    override fun onCreateView(
        ...
        binding.apply{
            ...
            uploadbtn1.setOnClickListener {
                validateData(binding.titlename.text.toString())
            }
        }
        return binding.root
    }
    ...
    private fun storeData(url: String, categoryName: String) {
        ...
        db.collection("categories").add(data)
            .addOnSuccessListener {
                dialog.dismiss()
                binding.Upload1.setImageDrawable(resources.getDrawable(R.drawable.upload))
                binding.titlename.text = null
                getData()
